            ...
            <div class="main-block">
               {{-- @foreach ($posts as $post) --}}
                ...
                <div class="row statistic text-center fs-16 p-3">
                    <div class="col "><p>Ferinds</p> <br> <p></p>{{$friends->count()}}</div>
                    <div class="col border-left"><p>Posts</p> <br> <p>{{$posts->count()}}</p></div>
                </div>
              {{--  @endforeach --}}
            </div>
        </div>
           ...
           <div class="main-block post-with-photo">
            ...
            <p  class="py-2 footer-btn text-center"><a onclick="likes({{ $post->id }})" id="like"data-postId="{{ $post->id }}"href="#">
             ...
             <span class="px-1"> Like</span></a></p>
                        ...
                        <div class="col border-left">
                            <p class=" py-2 footer-btn text-center"><a href=""><i class="fa fa-share-square-o" aria-hidden="true"></i> <span class="px-1"> Share</span> {!! $shareComponent !!}</a></p>
                        </div>
                    </div>
                    <hr class="mt-0 mb-2">
        ...
        <div class="col-3 mobile-hidden">
            <div class="main-block">
                ...
                <div class="row">
                   <div class="col-3">
                        <div class=" pt-2 pl-2 d-inline-block">
                            <div class="Profile-Picture " style="background: url('{{ asset('front/img/profile.jpg')}}');width: 40px;height: 40px;    border: 1.5px solid #8B54C7; "></div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="UserName d-inline-block mt-3">
                            <p><a href="" class="font-weight-bold">{{$user->name}}</a></p>
